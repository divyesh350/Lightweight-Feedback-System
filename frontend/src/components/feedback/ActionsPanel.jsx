...
export default function ActionsPanel({ onRequest, onViewPending, onExport }) {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <div className="bg-white rounded-lg shadow-sm p-5 mb-6">
        ...
        <div className="space-y-3 mb-6">
          ...
          <Button fullWidth variant="outlined" color="inherit" startIcon={<i className="ri-time-line"></i>} onClick={onViewPending} className="!rounded-button">
